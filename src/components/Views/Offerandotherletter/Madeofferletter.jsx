...
export default function Madeofferletter() {
  return (
    <>
      <Grid container>
      ...
      <Grid rows mx={"3.8rem"} mt={4} md={12} direction={"row"} display={"flex"}>
          ...
          <Grid md={6} style={{display:"flex",justifyContent:"flex-end"}}>
           <RouterLink to={"/Madeofferletter/Createofferletter"}> <Button variant="contained">+ Create Offer</Button></RouterLink>
          </Grid>
        </Grid>
        </Grid>
