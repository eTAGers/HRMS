    ...
    <>
      ...
      <Grid rows mx={"3.8rem"} mt={4} md={12} direction={"row"} display={"flex"}>
          ...
          <Grid md={6} style={{display:"flex",justifyContent:"flex-end"}}>
           <Button variant="contained" onClick={handleOpen}>+ Create Quote</Button>
          </Grid>
        </Grid>
        </Grid>
        ...
        <DataGrid
            ...
            columns={[
              ...
              { field: "col2", headerName: "Quote", width: 150 },
              { field: "col3", headerName: "Author", width: 150 },
              { field: "col4", headerName: "Create Date", width: 150 },
