...
export default function Payscales() {
  return (
    <>
      <Grid container>
        <Grid rows ml={"3.8rem"} mt={4}>
          ...
          <Breadcrumbs aria-label="breadcrumb">
            <RouterLink to={"/"}>
              ...
              <Typography color="text.primary">Payscales</Typography>
            </Breadcrumbs>
          </Grid>
        </Grid>
      </Grid>
      ...
      <Grid rows mx={"3.8rem"} mt={4} md={12} direction={"row"} display={"flex"}>
          ...
          <Grid md={6} style={{display:"flex",justifyContent:"flex-end"}}>
           <RouterLink to={"/Payscales/Createpayscales"}> <Button variant="contained">+ Create Payscales</Button></RouterLink>
          </Grid>
        </Grid>
        </Grid>
